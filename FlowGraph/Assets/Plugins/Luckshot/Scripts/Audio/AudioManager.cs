...
public class AudioManager : Singleton<AudioManager>
{
	...
	[SerializeField]
	private CollisionSFXMatrix collisionSFXMatrix = null;
	public CollisionSFXMatrix CollisionSFXMatrix
	{ get { return collisionSFXMatrix; } }
	...
	void AddSource()
	{
		AudioSource source = new GameObject("AudioSource-" + sourcePool.Count, typeof(AudioSource)).GetComponent<AudioSource>();
	...
	public AudioSource PlaySound(AudioClip clip, Transform parent = null, float volume = 1f, float pitch = 1f)
	{
		...
		TimeManager.Invoke(ReturnToPool, source, clip.length);
